...
function kulam_enqueue_scripts() {
	...
	// https://goodies.pixabay.com/javascript/auto-complete/demo.html
	wp_register_script( 'auto-complete',			get_stylesheet_directory_uri() . '/assets/js/libs/auto-complete.min.js',							array( 'jquery' ),									KULAM_VERSION,	true );
	wp_register_script( 'cycle2',					get_stylesheet_directory_uri() . '/assets/js/libs/jquery.cycle2.min.js',							array( 'jquery' ),									KULAM_VERSION,	true );
	wp_register_script( 'cycle2-swipe',				get_stylesheet_directory_uri() . '/assets/js/libs/jquery.cycle2.swipe.min.js',					array( 'jquery' ),									KULAM_VERSION,	true );
	wp_register_script( 'kulam-js',					get_stylesheet_directory_uri() . '/assets/js/min/scripts.min.js',									array( 'jquery', 'auto-complete' ),					KULAM_VERSION,	true );
