...
Additional Post Types may be added and re-sorted per each category', 'kulam-scoop'),
		...
		array(
			...
			'name' => 'acf-option_hmembership_register_page',
			'type' => 'page_link',
			'instructions' => '',
			'required' => 0,
			'conditional_logic' => 0,
		...
		array(
			...
			'name' => 'acf-option-registration_form_emails_delivery_opt-in_message',
			'type' => 'textarea',
			'instructions' => '',
			'required' => 0,
			'conditional_logic' => 0,
		...
		array(
			...
			'name' => 'acf-option-registration_form_privacy_policy_message',
			'type' => 'textarea',
			'instructions' => '',
			'required' => 0,
			'conditional_logic' => 0,
		...
		array(
			...
			'name' => 'acf-option-registration_form_cancelling_message',
			'type' => 'textarea',
			'instructions' => '',
			'required' => 0,
			'conditional_logic' => 0,
