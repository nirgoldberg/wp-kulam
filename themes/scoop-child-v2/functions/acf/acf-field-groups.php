...
Additional Post Types may be added and re-sorted per each category', 'kulam-scoop'),
		...
		array(
			...
			'sub_fields' => array(
				...
				array(
					'key' => 'field_5f7233f81b4af',
					'label' => __('Desktop Background', 'kulam-scoop'),
					'name' => 'desktop_background',
					'type' => 'image',
					'instructions' => __('Image dimensions: 1490x283 (px)', 'kulam-scoop'),
					'required' => 0,
					'conditional_logic' => 0,
					'wrapper' => array(
						'width' => '',
				...
				array(
					'key' => 'field_5f7235231b4b0',
					'label' => __('Mobile Background', 'kulam-scoop'),
					'name' => 'mobile_background',
					'type' => 'image',
					'instructions' => __('Image dimensions: 707x647 (px)', 'kulam-scoop'),
					'required' => 0,
					'conditional_logic' => 0,
					'wrapper' => array(
						'width' => '',
