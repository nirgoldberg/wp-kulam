	...
	<header class="entry-header">
		...
		<?php if ( is_category() ) {
			...
			if ( $popup_image && $popup_button_text ) {
				...
				<button class="button category-popup-button" data-toggle="modal" data-target="#modal-category-popup-image" style="<?php echo $style; ?>"><?php echo $popup_button_text; ?></button>
