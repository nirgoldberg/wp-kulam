 ...
 function(pswp, framework) {
	...
	var _overlayUIUpdated = false,
		...
		_defaultUIOptions = {
			...
			addDateHTMLFn: function(item, dateEl /*, isFake */) {
				if(!item.date) {
					dateEl.innerHTML = '';
					return false;
				}
			...
			shareButtons: [
				{id:'facebook', label:'Share on Facebook', url:'https://www.facebook.com/sharer/sharer.php?u={{raw_image_url}}'},
	...
	ui.update = function() {
		...
		if(_controlsVisible && pswp.currItem) {
			...
			if(_options.dateEl) {
				_options.addDateHTMLFn(pswp.currItem, _dateContainer);
			}
