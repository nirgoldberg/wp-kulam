...
acf_add_local_field_group(array(
	...
	'fields' => array(
		...
		array(
			'key' => 'field_5a37e0b65ee7d',
			'label' => __('Learn How / מדריכים', 'kulam-scoop'),
			'name' => 'learn_how_-_top_posts',
			'type' => 'post_object',
			'instructions' => '',
			'required' => 0,
			'conditional_logic' => 0,
		...
		array(
			'key' => 'field_5a37e339817d5',
			'label' => __('Music / מוזיקה', 'kulam-scoop'),
			'name' => 'music_-_top_posts',
			'type' => 'post_object',
			'instructions' => '',
			'required' => 0,
			'conditional_logic' => 0,
		...
		array(
			'key' => 'field_5a37e49b817d9',
			'label' => __('Ideas / מחשבה', 'kulam-scoop'),
			'name' => 'ideas_-_top_posts',
			'type' => 'post_object',
			'instructions' => '',
			'required' => 0,
			'conditional_logic' => 0,
