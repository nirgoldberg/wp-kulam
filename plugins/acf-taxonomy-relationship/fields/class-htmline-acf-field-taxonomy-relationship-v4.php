...
class htmline_acf_field_taxonomy_relationship extends acf_field {
	...
	*/
	...
	function __construct( $settings )
	{
		...
		$this->category = __("Basic",'acf-taxonomy-relationship'); // Basic, Content, Choice, etc
		$this->defaults = array(
...
<tr class="field_option field_option_<?php echo $this->name; ?>">
	<td class="label">
		<label><?php _e("Preview Size",'acf-taxonomy-relationship'); ?></label>
		<p class="description"><?php _e("Thumbnail is advised",'acf-taxonomy-relationship'); ?></p>
	</td>
	<td>
		<?php
		...
		do_action('acf/create_field', array(
			...
			'layout'	=>	'horizontal',
			'choices'	=>	array(
				'thumbnail' => __('Thumbnail', 'acf-taxonomy-relationship'),
				'something_else' => __('Something Else', 'acf-taxonomy-relationship'),
			)
		));
